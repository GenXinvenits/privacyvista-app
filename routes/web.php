...
$router->post('departments/delete', ['DepartmentsController', 'delete']);

$router->get('processing-activities', ['ProcessingActivitiesController', 'index']);
$router->get('processing-activities/create', ['ProcessingActivitiesController', 'create']);
$router->post('processing-activities/store', ['ProcessingActivitiesController', 'store']);
$router->get('processing-activities/edit', ['ProcessingActivitiesController', 'edit']);
$router->post('processing-activities/update', ['ProcessingActivitiesController', 'update']);
$router->post('processing-activities/delete', ['ProcessingActivitiesController', 'delete']);
