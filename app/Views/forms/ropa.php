...
?>
<div class="page-header mb-4 d-flex justify-content-between align-items-start"><div><div class="page-title">ROPA Master Register</div><div class="page-subtitle mb-0">Record and maintain the organisation's Record of Processing Activities.</div></div><span class="badge text-bg-secondary">Form v<?= (int)($template['version_number']??1) ?></span></div>
