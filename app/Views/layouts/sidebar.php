...
<aside class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column py-2" aria-label="Primary navigation">
        ...
        <button type="button" class="sidebar-section more-desktop-trigger" aria-expanded="false" aria-controls="privacyvista-more-group"><span>More</span> <span aria-hidden="true">⌄</span></button>
