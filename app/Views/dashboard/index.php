...
$sessionClientId = (int)($_SESSION['user']['client_id'] ?? 0);
$dashboardClientId = $isSuperuser ? 0 : $sessionClientId;
...
<?php foreach($statsCards as $s): ?>
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card dashboard-stat h-100">
            <div class="card-body">
                <div class="stat-icon">
                    <svg class="stat-icon-svg" width="21" height="21" style="width:21px;height:21px;max-width:21px;max-height:21px;display:block;flex:0 0 21px" fill="none" viewBox="0 0 28 28" stroke="currentColor" stroke-width="1.7" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" d="<?= e($s[4]) ?>"/></svg>
                </div>
