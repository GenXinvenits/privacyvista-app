...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a class="btn btn-primary" href="<?= url('processing-activities/create?client_id='.(int)$client['id']) ?>">Add activity</a>
    </div>
