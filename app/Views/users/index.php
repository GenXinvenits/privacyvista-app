...
<div class="card"><div class="card-body">
    <form method="get" class="row g-2 mb-3">
        ...
        <div class="col">
            <input type="search" name="q" class="form-control" placeholder="Search users..." value="<?= e($q ?? '') ?>">
        </div>
    ...
    <div class="table-responsive"><table class="table table-hover align-middle">
        ...
        <?php else: foreach ($users as $user): ?><tr>
            ...
            <td><a href="<?= url('users/edit', ['id' => $user['id']]) ?>" class="btn btn-sm btn-warning">Edit</a>
                <form method="post" action="<?= url('users/delete') ?>" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this user?');"><?php include __DIR__ . '/../partials/csrf.php'; ?><input type="hidden" name="id" value="<?= (int)$user['id'] ?>"><button type="submit" class="btn btn-sm btn-danger">Delete</button></form></td>
