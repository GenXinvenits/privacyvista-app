...
class ProcessingActivitiesController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        if (!$client) {
            $this->view('partials/client-context-required', ['title'=>'Select a client','message'=>'Processing Activities belong to a specific client. Please select a client before viewing or managing processing activities.','backRoute'=>'clients','backLabel'=>'Select Client']);
            return;
        }
