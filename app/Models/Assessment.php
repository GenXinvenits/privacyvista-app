...
class Assessment extends Model
{
 ...
 public function forClient(int $clientId):array{$s=$this->db->prepare('SELECT a.*,u.name AS owner_name FROM privacy_assessments a LEFT JOIN users u ON u.id=a.created_by WHERE a.client_id=? ORDER BY a.created_at DESC');$s->execute([$clientId]);return$s->fetchAll();}
